...
const Navbar = () => {
  ...
  return (
    ...
    <nav className='container mx-auto flex items-center justify-between py-4 px-6'>
        <div>
            <Link to="/" className='text-2xl font-medium hover:text-rabbit-dark'>
            Rabbit
            </Link>
        </div>
        ...
        <div className='hidden md:flex space-x-6'>
            ...
            <Link to="#" className='text-gray-700 hover:text-black text-sm font-medium uppercase'>Top Ware</Link>
            <Link to="#" className='text-gray-700 hover:text-black text-sm font-medium uppercase'>Bottom Ware</Link>
        </div>
